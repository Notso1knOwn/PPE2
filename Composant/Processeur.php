...
<head>
  ...
  <title>Processeur | 2TAK Hardware</title>
  ...
  <!-- row -->
    ...
    <div class="col-lg-3">
      ...
      <div class="list-group">
        <form method="post" action="Processeur.php">
        <!-- Formulaire Marque -->
        <div class="list-group-item">
            ...
            <div id="Marque" class="checkboxes">
              <label for="un">
                <input type="checkbox" id="un" name="Marque[]" value="Intel"/>Intel</label>
              <label for="deux">
                <input type="checkbox" id="deux" name="Marque[]" value="AMD"/>AMD</label>
            </div>
            <!-- checkboxes -->
          </div>
      ...
      <!-- list-group-item -->
        ...
        <div class="list-group-item">
            <div class="multiselect">
              <div class="selectBox form-group" onclick="showCheckboxes('Socket')">
                <div class="form-control">Socket</div>
              <div class="overSelect"></div>
            </div>
            <!-- multiselect -->
            <div id="Socket" class="checkboxes">
              <label for="un">
                <input type="checkbox" id="un" name="Socket[]" value="1151"/>1151</label>
              <label for="deux">
                <input type="checkbox" id="deux" name="Socket[]" value="AMD X570"/>AMD X570</label>
              <label for="trois">
                <input type="checkbox" id="trois" name="Socket[]" value="AMD B450"/>AMD B450</label>
            </div>
            <!-- checkboxes -->
          </div>
          <!-- multiselect  -->
        ...
        <div class="list-group-item">
            <div class="multiselect">
              <div class="selectBox form-group" onclick="showCheckboxes('Nbr_coeur')">
                <div class="form-control">Nombre de coeur</div>
              <div class="overSelect"></div>
            </div>
            <!-- multiselect -->
            <div id="Nbr_coeur" class="checkboxes">
              <label for="un">
                <input type="checkbox" id="un" name="Nbr_coeur[]" value="6"/>6</label>
              <label for="deux">
                <input type="checkbox" id="un" name="Nbr_coeur[]" value="8"/>8</label>
            </div>
            <!-- checkboxes -->
          </div>
          <!-- multiselect form-group -->
        ...
        <div class="list-group-item">
            ...
            <div id="Frequence" class="checkboxes">
              <label for="un">
                <input type="checkbox" id="un" name="Frequence[]" value="4.2"/>4.2Hz</label>
              <label for="deux">
                <input type="checkbox" id="un" name="Frequence[]" value="4.4"/>4.4Hz</label>
            </div>
            <!-- Carte_graphique -->
          </div>
          <!-- multiselect -->
    ...
    <div class="col-lg-9">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100">
          <?php   $image = "../Images/Composants/Processeur/".$key['Modele'].".jpg";  ?>
          ...
          <div class="card-footer">
            <p class="card-text"><?php echo $key['PrixUnitaireHT']."€"; ?></p>
          </div>
          <div class="card-footer">
