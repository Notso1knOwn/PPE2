...
<head>
  ...
  <title>Carte Graphique | 2TAK Hardware</title>
  ...
  <!-- row -->
    ...
    <div class="col-lg-3">
      ...
      <div class="list-group">
        ...
        <div class="list-group-item">
            ...
            <div id="Marque" class="checkboxes">
              ...
              <label for="deux">
                <input type="checkbox" id="deux" name="Marque[]" value="AORUS"/>AORUS</label>
            </div>
            <!-- checkboxes -->
          </div>
      ...
      <!-- list-group-item -->
        ...
        <div class="list-group-item">
            <div class="multiselect">
              <div class="selectBox form-group" onclick="showCheckboxes('Memoire')">
                <div class="form-control">Memoire</div>
              <div class="overSelect"></div>
            </div>
            <!-- multiselect -->
            <div id="Memoire" class="checkboxes">
              <label for="un">
                <input type="checkbox" id="un" name="Memoire[]" value="8"/>8 Go</label>
              <label for="deux">
                <input type="checkbox" id="deux" name="Memoire[]" value="6"/>6 Go</label>
              <label for="trois">
                <input type="checkbox" id="trois" name="Memoire[]" value="4"/>4 Go</label>
            </div>
            <!-- checkboxes -->
          </div>
          <!-- multiselect  -->
        ...
        <div class="list-group-item">
            <div class="multiselect">
              <div class="selectBox form-group" onclick="showCheckboxes('Type_memoire')">
                <div class="form-control">Type memoire</div>
              <div class="overSelect"></div>
            </div>
            <!-- multiselect -->
            <div id="Type_memoire" class="checkboxes">
              <label for="un">
                <input type="checkbox" id="un" name="Type_memoire[]" value="GDDR6"/>GDDR6</label>
            </div>
            <!-- checkboxes -->
          </div>
          <!-- multiselect form-group -->
    ...
    <div class="col-lg-9">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100">
          <?php   $image = "../Images/Composants/Carte_graphique/".$key['Modele'].".jpg";  ?>
