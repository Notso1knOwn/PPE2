      ...
      <!-- list-group-item -->
        ...
        <div class="list-group-item">
            ...
            <div id="Socket" class="checkboxes">
              <label for="un">
                <input type="checkbox" id="un" name="Socket[]" value="Mini"/>Mini-PC</label>
              <label for="deux">
                <input type="checkbox" id="deux" name="Socket[]" value="Bureautique"/>PC Tour bureautique</label>
              <label for="trois">
                <input type="checkbox" id="trois" name="Socket[]" value="Gamer"/>Gamer</label>
            </div>
            <!-- checkboxes -->
          </div>
          <!-- multiselect  -->
        ...
        <div class="list-group-item">
            ...
            <div id="Nbr_coeur" class="checkboxes">
              <label for="un">
                <input type="checkbox" id="un" name="Nbr_coeur[]" value="Intel Pentium"/>Intel Pentium</label>
            </div>
            <!-- checkboxes -->
          </div>
          <!-- multiselect form-group -->
        ...
        <div class="list-group-item">
            ...
            <div id="Frequence" class="checkboxes">
              <label for="un">
                <input type="checkbox" id="un" name="Frequence[]" value="Intel HD"/>4.2Hz</label>
            </div>
            <!-- Carte_graphique -->
          </div>
          <!-- multiselect -->
    ...
    <div class="col-lg-9">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100">
          <?php   $image = "../Images/Ordinateur/Tour/".$key['Modele'].".jpg";  ?>
