...
<head>
  ...
  <title>Carte mère | 2TAK Hardware</title>
  ...
  <!-- row -->
    ...
    <div class="col-lg-3">
      ...
      <div class="list-group">
        <form method="post" action="Carte_mère.php">
        <!-- Formulaire Marque -->
      ...
      <!-- list-group-item -->
        ...
        <div class="list-group-item">
            <div class="multiselect">
              <div class="selectBox form-group" onclick="showCheckboxes('Chipset')">
                <div class="form-control">Chipset</div>
              <div class="overSelect"></div>
            </div>
            <!-- multiselect -->
            <div id="Chipset" class="checkboxes">
              <label for="un">
                <input type="checkbox" id="un" name="Chipset[]" value="Intel B360"/>Intel B360</label>
              <!-- <label for="deux">
        ...
        <div class="list-group-item">
            ...
            <div id="Format" class="checkboxes">
              <label for="un">
                <input type="checkbox" id="un" name="Format[]" value="ATX"/>ATX</label>
            </div>
            <!-- checkboxes -->
          </div>
          <!-- multiselect form-group -->
    ...
    <div class="col-lg-9">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100">
          <?php   $image = "../Images/Composants/Carte_mère/".$key['Modele'].".jpg";  ?>
